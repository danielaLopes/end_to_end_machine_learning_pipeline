...
def create(
    ...
    try:
        feature_views = fs.get_feature_views(name=f"{settings.SETTINGS["FS_PROJECT_NAME"]}_view")
    except hsfs.client.exceptions.RestAPIError:
        logger.info(f"No feature views found for {settings.SETTINGS["FS_PROJECT_NAME"]}_view.")
    ...
    feature_view = fs.create_feature_view(
        name=f"{settings.SETTINGS["FS_PROJECT_NAME"]}_view",
